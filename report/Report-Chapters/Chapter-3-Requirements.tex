...
\begin{requirement}{Result display (Optional)}
\noindent
...
\begin{requirement}{File searching}
\noindent
...
\footnotetext{See \url{https://en.wikipedia.org/wiki/Diff\_utility} for an explanation of diff}
