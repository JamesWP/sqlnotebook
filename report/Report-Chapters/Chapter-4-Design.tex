...
Fig \ref{fig:binder} shows the implemented simple folder structure. The names given to the levels are as follows: Binder, top level container. Tab, second level container.
...
This technique, called ``serial scanning''\footenote{
\url{https://en.wikipedia.org/wiki/Full_text_search#Indexing} has more details
on this}, is only typically used for smaller amounts of text due to this problem.
